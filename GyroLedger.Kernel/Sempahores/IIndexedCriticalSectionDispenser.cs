...
public interface IIndexedCriticalSectionDispenser<TKey, TBarrier>
    where TKey: struct, IEquatable<TKey>
    where TBarrier : SemaphoreBarrier, IIndexableSemaphoreBarrier<TKey>, new()
{
    /// <summary>
    /// Called by <see cref="IndexedCriticalSection{TKey, TBarrier}"/> to signal starting use of barriers in a DI-scope."
    /// </summary>
    /// <remarks>Called in <see cref="IndexedCriticalSection{TKey, TBarrier}"/> ctor()</remarks>
    void StartingUse();

    /// <summary>
    /// Called by <see cref="IndexedCriticalSection{TKey, TBarrier}"/> to signal finished use of barriers in a DI-scope."
    /// </summary>
    /// <remarks>Called in <see cref="IndexedCriticalSection{TKey, TBarrier}"/> Dispose</remarks>
    void FinishedUse();
